<%@ Page Title="" Language="C#" MasterPageFile="~/Setup/SetupMaster.master" AutoEventWireup="true" CodeBehind="AccountType.aspx.cs" Inherits="Cooperatiove.Setup.AccountType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-6 col-xs-6">
            <h3>
                <i class="fa fa-group"></i>&nbsp; AccountType
            </h3>
        </div>
            ...
            <div class="col-md-12" style="position:inherit">
                <div id="entry-form" class="entry-form">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">AccountTypeName:</label>
                        <div class="col-sm-3">
                            <asp:TextBox runat="server" ID="txtAccountTypeName" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3" style="margin-left: 15%;"> &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button runat="server" ID="btnSave" CssClass="btn btn-default"  Text="Save" OnClick="btnSave_Click" ></asp:Button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
            ...
            <asp:GridView ID="gdvAccountTypeList" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                onpageindexchanging="gdvAccountTypeList_PageIndexChanging" AllowPaging="True">
                <Columns>
